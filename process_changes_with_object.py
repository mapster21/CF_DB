# Transforming a large dataset in text format - over 5000 lines of text.
# Data are scrubed (cleaned) and placed into the relevant holder/container objects.
...
# Once the data are in these objects there are 422 different sets of commit objects in the changes.csv.
