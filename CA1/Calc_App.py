# Scientific Calculator GUI to call functions from 'calc.py' calculator program.
...
#    def tan(self):
#        self.total = float(math.tan(math.radians(self.total)))
...
text_box = Entry(calc, justify=RIGHT,width=28,font="Times 16 bold")
text_box.grid(row = 0, column = 0,columnspan = 6,padx=20, pady = 20)
text_box.insert(0, "0")
